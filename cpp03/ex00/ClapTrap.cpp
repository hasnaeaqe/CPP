...
//     if (hitPoints == 0)
//     {
//         std::cout<<name<<" is destroyed and Can't attack!"<<std::endl;
//         return ;
//     }
//     if (energyPoints == 0)
//     {
//         std::cout<<name<<" has no energy points left and Can't attack! "<<std::endl;
//         return ;
//     }
//     energyPoints--;
//     std::cout<<"ClapTrap "<<name<<" attacks "<<target<<", causing "<<attackDamage<<" points of damage!"<<std::endl;
...
//     {
//         hitPoints -=   amount;
//         std::cout<<name<<" now has "<<hitPoints<<" hit points left! "<<std::endl;
//     }
// }
// void ClapTrap::beRepaired(unsigned int amount)
// {
//     if (hitPoints == 0)
//     {
//         std::cout<<name<<" is destroyed and Can't be repaired!"<<std::endl;
//         return ;
//     }
//     if (energyPoints == 0)
//     {
//         std::cout<<name<<" has no energy points left and Can't be repaired!"<<std::endl;
//         return ;
//     }
//     hitPoints = hitPoints + amount;
//     energyPoints--;
