...
ClapTrap::ClapTrap():hitPoints(10),energyPoints(10), attackDamage(0){ std::cout<<"ClapTrap's Default Constructor Called"<<std::endl;}
...
{ std::cout<<"ClapTrap's Constructor with params Called"<<std::endl;}

ClapTrap::ClapTrap(std::string name):name(name)
{ std::cout<<"ClapTrap's Constructor with params name Called"<<std::endl;}
...
{
    std::cout<<"ClapTrap's copy assignement operator Called"<<std::endl;
    if (this != &autre)
    {
        hitPoints = autre.hitPoints;
        energyPoints = autre.energyPoints;
